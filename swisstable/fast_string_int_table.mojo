"""Specialized SwissTable for String->Int mappings.

Eliminates generic overhead by using concrete types instead of generic parameters.
Expected performance improvement: 10-30% over generic SwissTable.
"""
...
struct FastStringIntTable(Movable, Sized, Copyable):
    """Specialized high-performance SwissTable for String->Int mappings.
    
    Eliminates generic overhead by using concrete String/Int types.
    Should be faster than SwissTable[String, Int, MojoHashFunction] by avoiding
    ...
    var _slots: UnsafePointer[DictEntry[String, Int]]
    ...
    fn __init__(out self):
        ...
        self._slots = UnsafePointer[DictEntry[String, Int]]()
    ...
    fn __moveinit__(out self, owned existing: Self):
        ...
        existing._slots = UnsafePointer[DictEntry[String, Int]]()
    ...
    fn __copyinit__(out self, existing: Self):
        ...
        if existing._capacity > 0:
            ...
            self._slots = UnsafePointer[DictEntry[String, Int]].alloc(Int(existing._capacity))
    ...
    fn insert(mut self, key: String, value: Int) -> Bool:
        ...
        var result = unified_find_slot[String, Int](
            self._control_bytes, 
            self._slots,
            Int(self._capacity), 
            key, 
    ...
    @always_inline  
    fn lookup(self, key: String) -> Optional[Int]:
        ...
        return unified_lookup[String, Int](
            self._control_bytes,
            self._slots,
            Int(self._capacity),
            key,
    ...
    fn delete(mut self, key: String) -> Bool:
        ...
        var result = unified_delete[String, Int](
            self._control_bytes,
            self._slots,
            Int(self._capacity),
            key,
    ...
    @always_inline
    fn get(self, key: String, default: Int) -> Int:
    ...
    fn _allocate_table(mut self, min_capacity: Int):
        ...
        self._slots = UnsafePointer[DictEntry[String, Int]].alloc(actual_capacity)
    ...
    fn _resize(mut self):
        ...
        for old_slot_idx in range(Int(old_capacity)):
            ...
            if is_full(ctrl):
                ...
                var slot_index = unified_resize_insert[String, Int](
                    self._control_bytes, 
                    UnsafePointer[DictEntry[String, Int]](self._slots),
                    Int(self._capacity),
                    entry.key, 
                    entry.value, 
                    hash_val
