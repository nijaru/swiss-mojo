"""Specialized SwissTable for String->String mappings.

Eliminates generic overhead by using concrete types instead of generic parameters.
Expected performance improvement: 5-10% over generic SwissTable[String, String].
"""
...
struct FastStringStringTable(Movable, Sized, Copyable):
    """Specialized high-performance SwissTable for String->String mappings.
    
    Eliminates generic overhead by using concrete String/String types.
    Should be faster than SwissTable[String, String, MojoHashFunction] by avoiding
    ...
    var _slots: UnsafePointer[DictEntry[String, String]]
    ...
    fn __init__(out self):
        ...
        self._slots = UnsafePointer[DictEntry[String, String]]()
    ...
    fn __moveinit__(out self, owned existing: Self):
        ...
        existing._slots = UnsafePointer[DictEntry[String, String]]()
    ...
    fn __copyinit__(out self, existing: Self):
        ...
        if existing._capacity > 0:
            ...
            self._slots = UnsafePointer[DictEntry[String, String]].alloc(Int(existing._capacity))
    ...
    fn insert(mut self, key: String, value: String) -> Bool:
        ...
        var result = unified_find_slot[String, String](
            self._control_bytes, 
            self._slots,
            Int(self._capacity), 
            key, 
    ...
    @always_inline  
    fn lookup(self, key: String) -> Optional[String]:
        ...
        return unified_lookup[String, String](
            self._control_bytes,
            self._slots,
            Int(self._capacity),
            key,
    ...
    fn delete(mut self, key: String) -> Bool:
        ...
        var result = unified_delete[String, String](
            self._control_bytes,
            self._slots,
            Int(self._capacity),
            key,
    ...
    fn _allocate_table(mut self, min_capacity: Int):
        ...
        self._slots = UnsafePointer[DictEntry[String, String]].alloc(actual_capacity)
    ...
    fn _resize(mut self):
        ...
        for old_slot_idx in range(Int(old_capacity)):
            ...
            if is_full(ctrl):
                ...
                var slot_index = unified_resize_insert[String, String](
                    self._control_bytes, 
                    self._slots,
                    Int(self._capacity),
                    entry.key, 
